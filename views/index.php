...
<head>
  ...
  <title>Kavasam cybersecurity Lab</title>
...
<body>
  ...
  <div class="container-warp">
      ...
      <div class="d-flex">
        ...
        <div class="d-flex align-items-center ml-3">
          <div class="d-flex-col">
            ...
            <a href="labview.php" class="btn btn-shin mt-3">Start a Challenge</a>
    ...
    <hr class="kavasam-hr">
    <section class="container-fluid  labtodo d-flex  align-items-center "
      style="margin-top: 60px; margin-bottom: 170px;  margin-left: 120px;">
      ...
      <div class="lab-description">
        ...
        <p class="main-p">In this section, you'll get hands-on experience with real-world cybersecurity challenges.
          <br>You'll learn how to exploit vulnerabilities, crack codes, and secure systems.<br> Each challenge is
          designed to teach you a specific skill or technique, so you can apply what you've learned to real-world
          situations.</p>
        <p class="main-p">Remember, the best way to learn cybersecurity is by doing. So roll up your sleeves and get
          started!</p>
    ...
    <section id="ctf-flag">
      <div class=" ctf-flag-container">
        <h2 class="text-center about-h1" style=" padding-top: 30px;">CTF <span class="main-h1-span pt-2">Flag</span>
        </h2>
        <p class="text-center">Here's where we'll display the CTF flag once it's captured.</p>
        <div id=" d-flex" class="d-flex align-items-center " style="margin-left: 120px;"">
          <div>
          <img src=" ../assets/flag.png" alt="" width="300" height="400">
        </div>

        <div class="pl-4" style="    padding-left: 100px;">
          <h2 class="about-h1">Welcome to the Capture <span class="main-h1-span pt-2">The Flag challenge!</span></h2>
          <p>
            In this section, you'll be tasked with finding and capturing a hidden flag.<br> The flag is a piece of text
            or a code that you'll need to find by exploiting vulnerabilities, cracking codes, and solving puzzles.</p>
          <!-- <p>Once you've found the flag, enter it below to complete the challenge. Remember, the goal is not just to find the flag, but to understand how you found it. Good luck!</p> -->
        </div>
    ...
    <div class="container-fluid bg-footer px-3" style="padding-top: 40px; padding-bottom: 20px;  ">
      <div class="row">
        <div class="col-md-4">
          ...
          <p class="footer-p"><span class="main-h1-span pt-2 fw-bold">Kavasam</span> is your ultimate shield in the
            digital world. We provide a robust platform for cybersecurity enthusiasts to learn, practice, and master
            various aspects of cybersecurity.</p>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          ...
          <p class="footer-p"><span class="main-h1-span pt-2 fw-bold">Kavasam</span> Cybersecurity Labs<br>1234 Cyber
            Street<br>Tamilnadu, India</p>
